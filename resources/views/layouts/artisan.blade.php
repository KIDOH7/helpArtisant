<!DOCTYPE html>
<!-- saved from url=(0070)https://demos.creative-tim.com/material-dashboard/pages/dashboard.html -->
<html lang="en" class="">
<head>
  ...
  <title _msttexthash="1462019" _msthash="0">ôthaentik accueil par Creative Tim</title>
  ...
  <link rel="stylesheet" type="text/css') }}" href="{{ asset('acceuil_files/css') }}">
  <link href="{{ asset('acceuil_files/nucleo-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('acceuil_files/nucleo-svg.css') }}" rel="stylesheet">
  <script src="{{ asset('acceuil_files/token_create.js.télécharger') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/js') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/js(1)')}}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/identify_a19ff03d.js.télécharger') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/main.MWY4NzUyNDJiMw.js.télécharger') }}" data-id="CC6UAQBC77U7GVKHLC4G"></script>
  <script async="" src="{{ asset('acceuil_files/main.ea1c939c.js.télécharger') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/events.js.télécharger') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/insight.min.js.télécharger') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/core.js.télécharger') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/analytics.js.télécharger') }}"></script>
  <script type="text/javascript" async="" src="{{ asset('acceuil_files/js(2)')}}"></script>
  <script async="" src="{{ asset('acceuil_files/gtm.js.télécharger') }}"></script>
  <script async="" src="{{ asset('acceuil_files/analytics.js.télécharger') }}"></script>
  <script src="{{ asset('acceuil_files/42d5adcbca.js.télécharger') }}" crossorigin="anonymous"></script>
  ...
  <link href="{{ asset('acceuil_files/icon')}}" rel="stylesheet">
  <link id="pagestyle" href="{{ asset('acceuil_files/material-dashboard.min.css') }}" rel="stylesheet">
  <style>
  .async-hide {
      opacity: 0 !important
    }
  ...
  <script defer="" data-site="demos.creative-tim.com" src="{{ asset('acceuil_files/nepcha-analytics.js.télécharger') }}"></script>
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark ps" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/material-dashboard/pages/dashboard" target="_blank">
        <img src="{{ asset('acceuil_files/logo-ct.webp')}}" class="navbar-brand-img h-100" alt="main_logo" _mstalt="136175" _msthash="1">
        <span class="ms-1 font-weight-bold text-white" _msttexthash="722137" _msthash="2">ôthaentik accueil</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto ps ps--active-y" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="acceuil.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10" _msttexthash="229684" _msthash="3">tableau de bord</i>
            </div>
            <span class="nav-link-text ms-1" _msttexthash="226772" _msthash="4">Tableau de bord</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="#">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10" _msttexthash="207532" _msthash="7">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1" _msttexthash="183014" _msthash="8">Publier votre produits</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white " href="visibility.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10" _msttexthash="207532" _msthash="7">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1" _msttexthash="183014" _msthash="8">Plus visibilité</span>  
          </a>
        </li>


        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8" _msttexthash="230841" _msthash="15">Pages de compte</h6>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white " href="form_modif.php">
            <span class="nav-link-text ms-1" _msttexthash="77246" _msthash="17">Modifier mes informations</span>
          </a>
        </li>
      ...
      <div class="ps__rail-y" style="top: 0px; height: 454px; right: 0px;">
        <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 420px;">
        </div>
      </div>
    </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="fil d’Ariane" _mstaria-label="157144" _msthash="24">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm">
              <a class="opacity-5 text-dark" href="javascript:;" _msttexthash="58994" _msthash="25">Pages</a>
            </li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page" _msttexthash="226772" _msthash="26">Tableau de bord ôtheantki</li>
          </ol>
          <h6 class="font-weight-bolder mb-0" _msttexthash="226772" _msthash="27">Tableau de bord</h6>
        </nav>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="https://www.creative-tim.com/builder?ref=navbar-material-dashboard" _msttexthash="424788" _msthash="29">Constructeur en ligne</a>
            </li>
            <li class="mt-2">
              <span>
                <template shadowrootmode="closed">
                  ...
                  <div class="widget widget-lg">
                    <a class="btn" href="https://github.com/creativetimofficial/material-dashboard" rel="noopener" target="_blank" aria-label="Star creativetimofficial/material-dashboard on GitHub">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{ asset('acceuil_files/team-2.jpg')}}" class="avatar avatar-sm  me-3 ">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <font _mstmutation="1" _msttexthash="446017" _msthash="31">
                            <span class="font-weight-bold" _mstmutation="1" _istranslated="1">Nouveau message</span>de Laur</font>
                        </h6>
                        <p class="text-xs text-secondary mb-0">
                          <i class="fa fa-clock me-1" aria-hidden="true"></i>
                          <font _mstmutation="1" _msttexthash="223509" _msthash="32">il y a 13 minutes</font>
                        </p>
                      </div>
                    </div>
                  </a>
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="compte.php" class="nav-link text-body font-weight-bold px-0">
                <i class="fa fa-user me-sm-1" aria-hidden="true"></i>
                <span class="d-sm-inline d-none" _msttexthash="137371" _msthash="38">acceder a mes informations</span>
              </a>
            </li>
          </ul>
  ...
  document.write(new Date().getFullYear())
                ...
                <font _mstmutation="1" _msttexthash="2008370" _msthash="150">2024, réalisé avec par
                  <a href="https://www.creative-tim.com/" class="font-weight-bold" target="_blank" _mstmutation="1" _istranslated="1">Creative Tim</a>pour un meilleur web.</font>
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com/" class="nav-link text-muted" target="_blank" _msttexthash="176033" _msthash="151">Tim créatif</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.creative-tim.com/presentation" class="nav-link text-muted" target="_blank" _msttexthash="257322" _msthash="152">Qui sommes-nous</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.creative-tim.com/blog" class="nav-link text-muted" target="_blank" _msttexthash="43615" _msthash="153">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.creative-tim.com/license" class="nav-link pe-0 text-muted" target="_blank" _msttexthash="90792" _msthash="154">Licence</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="ps__rail-y" style="top: 0px; height: 654px; right: 0px;">
      <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 334px;">
      </div>
    </div>
  </main>
  <div class="fixed-plugin ps">
    <a class="fixed-plugin-button text-dark position-fixed px-3 py-2">
      <i class="material-icons py-2" _msttexthash="179062" _msthash="155">Paramètres</i>
    </a>
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0" _msttexthash="4108065" _msthash="156">Configurateur d’interface utilisateur matérielle</h5>
          <p _msttexthash="1132443" _msthash="157">Consultez nos options de tableau de bord.</p>
        </div>
        <div class="float-end mt-4">
          <button class="btn btn-link text-dark p-0 fixed-plugin-close-button">
            <i class="material-icons" _msttexthash="61542" _msthash="158">clair</i>
          </button>
        </div>
      </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        <div>
          <h6 class="mb-0" _msttexthash="695786" _msthash="159">Couleurs de la barre latérale</h6>
        </div>
        ...
        <div class="mt-3">
          <h6 class="mb-0" _msttexthash="655226" _msthash="160">Type de navigation latérale</h6>
          <p class="text-sm" _msttexthash="1563198" _msthash="161">Choisissez entre 2 types de sidenav différents.</p>
        </div>
        <div class="d-flex">
          <button class="btn bg-gradient-dark px-3 mb-2 active" data-class="bg-gradient-dark" onclick="sidebarType(this)" _msttexthash="76648" _msthash="162">Sombre</button>
          <button class="btn bg-gradient-dark px-3 mb-2 ms-2" data-class="bg-transparent" onclick="sidebarType(this)" _msttexthash="184418" _msthash="163">Transparent</button>
          <button class="btn bg-gradient-dark px-3 mb-2 ms-2" data-class="bg-white" onclick="sidebarType(this)" _msttexthash="57044" _msthash="164">Blanc</button>
        </div>
        <p class="text-sm d-xl-none d-block mt-2" _msttexthash="1736683" _msthidden="1" _msthash="165">You can change the sidenav type just on desktop view.</p>
        <div class="mt-3 d-flex">
          <h6 class="mb-0" _msttexthash="491530" _msthash="166">Barre de navigation fixe</h6>
        ...
        <div class="mt-2 d-flex">
          <h6 class="mb-0" _msttexthash="191529" _msthash="167">Clair / Foncé</h6>
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input class="form-check-input mt-1 ms-auto" type="checkbox" id="dark-version" onclick="darkMode(this)">
          </div>
        </div>
        <hr class="horizontal dark my-sm-4">
        <a class="btn bg-gradient-info w-100" href="https://www.creative-tim.com/product/material-dashboard-pro" _msttexthash="528619" _msthash="168">Téléchargement gratuit</a>
        <a class="btn btn-outline-dark w-100" href="https://www.creative-tim.com/learning-lab/bootstrap/overview/material-dashboard" _msttexthash="424281" _msthash="169">Voir la documentation</a>
  ...
  body{margin:0}a{text-decoration:none;outline:0}.widget{display:inline-block;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif;font-size:0;line-height:0;white-space:nowrap}.btn,.social-count{position:relative;display:inline-block;display:inline-flex;height:14px;padding:2px 5px;font-size:11px;font-weight:600;line-height:14px;vertical-align:bottom;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background-repeat:repeat-x;background-position:-1px -1px;background-size:110% 110%;border:1px solid}.btn{border-radius:.25em}.btn:not(:last-child){border-radius:.25em 0 0 .25em}.social-count{border-left:0;border-radius:0 .25em .25em 0}.widget-lg .btn,.widget-lg .social-count{height:16px;padding:5px 10px;font-size:12px;line-height:16px}.octicon{display:inline-block;vertical-align:text-top;fill:currentColor;overflow:visible}.btn:focus-visible,.social-count:focus-visible{outline:2px solid #0969da;outline-offset:-2px}.btn{color:#24292f;background-color:#ebf0f4;border-color:#d0d7de;background-image:url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg'%3e%3clinearGradient id='o' x2='0' y2='1'%3e%3cstop stop-color='%23f6f8fa'/%3e%3cstop offset='90%25' stop-color='%23ebf0f4'/%3e%3c/linearGradient%3e%3crect width='100%25' height='100%25' fill='url(%23o)'/%3e%3c/svg%3e");background-image:-moz-linear-gradient(top, #f6f8fa, #ebf0f4 90%);background-image:linear-gradient(180deg, #f6f8fa, #ebf0f4 90%);filter:progid:DXImageTransform.Microsoft.Gradient(startColorstr='#FFF6F8FA', endColorstr='#FFEAEFF3')}:root .btn{filter:none}.btn:hover,.btn:focus{background-color:#e4e9ed;background-position:0 -0.5em;border-color:#d0d7de;background-image:url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg'%3e%3clinearGradient id='o' x2='0' y2='1'%3e%3cstop stop-color='%23eef1f4'/%3e%3cstop offset='90%25' stop-color='%23e4e9ed'/%3e%3c/linearGradient%3e%3crect width='100%25' height='100%25' fill='url(%23o)'/%3e%3c/svg%3e");background-image:-moz-linear-gradient(top, #eef1f4, #e4e9ed 90%);background-image:linear-gradient(180deg, #eef1f4, #e4e9ed 90%);filter:progid:DXImageTransform.Microsoft.Gradient(startColorstr='#FFEEF1F4', endColorstr='#FFE3E8EC')}:root .btn:hover,:root .btn:focus{filter:none}.btn:active{background-color:#e7ebef;border-color:#d0d7de;background-image:none;filter:none}.social-count{color:#24292f;background-color:#fff;border-color:#d0d7de}.social-count:hover,.social-count:focus{color:#0969da}.octicon-heart{color:#bf3989}
              ...
              <div class="widget widget-lg">
                ...
                <a class="social-count" href="https://github.com/creativetimofficial/material-dashboard/stargazers" rel="noopener" target="_blank" aria-label="10962 stargazers on GitHub">10,962</a>
              </div>
            </template>
          </span>
          <h6 class="mt-3" _msttexthash="395525" _msthash="171">Merci pour le partage !</h6>
          <a href="https://twitter.com/intent/tweet?text=Check%20Material%20UI%20Dashboard%20made%20by%20%40CreativeTim%20%23webdesign%20%23dashboard%20%23bootstrap5&amp;url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fsoft-ui-dashboard" class="btn btn-dark mb-0 me-2" target="_blank">
            <i class="fab fa-twitter me-1" aria-hidden="true"></i>
            <font _mstmutation="1" _msttexthash="61555" _msthash="172">Tweet</font>
          </a>
          <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com/product/material-dashboard" class="btn btn-dark mb-0 me-2" target="_blank">
            <i class="fab fa-facebook-square me-1" aria-hidden="true"></i>
            <font _mstmutation="1" _msttexthash="113542" _msthash="173">Partager</font>
          </a>
        </div>
      </div>
    </div>
  ...
  <script src="{{ asset('acceuil_files/popper.min.js.télécharger') }}"></script>
  <script src="{{ asset('acceuil_files/bootstrap.min.js.télécharger') }}"></script>
  <script src="{{ asset('acceuil_files/perfect-scrollbar.min.js.télécharger') }}"></script>
  <script src="{{ asset('acceuil_files/smooth-scrollbar.min.js.télécharger') }}"></script>
  <script src="{{ asset('acceuil_files/chartjs.min.js.télécharger') }}"></script>
  <style>
  #ofBar {
      background: #fff;
      z-index: 999999999;
  ...
  <script async="" defer="" src="{{ asset('acceuil_files/buttons.js.télécharger') }}"></script>
  <script src="{{ asset('acceuil_files/material-dashboard.min.js.télécharger') }}"></script>
  <script defer="" src="{{ asset('acceuil_files/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon="{&quot;rayId&quot;:&quot;8a1fbc727d22b79e&quot;,&quot;serverTiming&quot;:{},&quot;version&quot;:&quot;2024.6.1&quot;,&quot;token&quot;:&quot;1b7cbb72744b40c580f8633c6b62637e&quot;}" crossorigin="anonymous"></script>
</body>
