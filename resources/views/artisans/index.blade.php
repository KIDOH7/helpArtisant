    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $artisan->localisation_entreprise }}</td>
                <td>{{ $artisan->annee_existence }}an(s)</td>
                <td>
                    <a href="{{ route('artisans.show', $artisan->id) }}" class="btn btn-info">Voir</a>
                    <a href="{{ route('artisans.edit', $artisan->id) }}" class="btn btn-warning">Éditer</a>
